...
export const ContactCTA = () => (
  <section id="orcamento" className="py-24 scroll-mt-20">
      ...
      {[
        {
          ...
          link: PORTFOLIO_DATA.links.whatsapp,
        },
        {
          name: "Consultoria PJ",
          ...
          link: PORTFOLIO_DATA.links.email,
        },
        {
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="w-full p-8 rounded-3xl bg-gradient-to-r from-primary/10 to-transparent border border-primary/20 flex flex-col md:flex-row items-center justify-between group hover:from-primary/20 transition-all gap-6"
    >
